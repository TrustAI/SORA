...
from direct_with_lb import LowBoundedDIRECT
...
# from Resized_MNIST.utils import load_resized_mnist
...
def get_args():
    ...
    parser.add_argument('--model-name', default='mnist_relu_9_200', type=str)
...
def main():
    ...
    opt_out = model(optimal_img.unsqueeze(0).to(args.device))
